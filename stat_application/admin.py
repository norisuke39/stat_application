...
class FileNameAdmin(admin.ModelAdmin):
    list_display = ('id', 'file_name', 'upload_time','file_obj','session_id')
    list_display_links = ('id', 'file_name')
    
class MethodAdmin(admin.ModelAdmin):
    list_display = ('id', 'model_ja','model_en', 'upload_time','session_id')
...
class SummaryAdmin(admin.ModelAdmin):
    list_display = ('id', 'model','aic', 'bic' ,'hqic' , 'p','d','q','sp','sd','sq','method','upload_time','rsq','rsq_adj','holdout','dw','session_id')
    list_display_links = ('id', 'model','aic', 'bic' ,'hqic' , 'p','d','q','sp','sd','sq','method','upload_time','rsq','rsq_adj','holdout','dw','session_id')
